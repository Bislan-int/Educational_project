...
class HomeFragment : Fragment() {
    ...
    val filmsDataBase = listOf(
        Film("Moon Knight", R.drawable.moon_knight, "Steven Grant discovers he's been granted the powers of an Egyptian moon god. But he soon finds out that these newfound powers can be both a blessing and a curse to his troubled life.", 5.5f),
        ...
        Film("Black Widow", R.drawable.black_widow, "The new MARVEL blockbuster will tell the backstory of Natasha Romanoff, also known as the Black Widow, before she became one of the Avengers team.", 7.1f),
        Film("Shang Chi", R.drawable.shang_chi, "Martial artist Shang-Chi must confront ghosts from his own past as he is drawn into a web of intrigue by the mysterious Ten Rings organization.", 7.5f),
        ...
        Film("The Wheel of Time", R.drawable.time, "Set in a high fantasy world where magic exists, but only some can access it, a woman named Moiraine crosses paths with five young men and women. This sparks a dangerous, world-spanning journey. Based on the book series by Robert Jordan.",2.1f)
    )
